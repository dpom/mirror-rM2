...
** #1 The screen rendering is incorrect
...
- adaug touch
  ...
  (def line (first @(:lines state)))

  (def points (:points line))

  (def smooth-bin-length 10)

  (def smooth-bin (first
                    (partition-all smooth-bin-length points)))
  
  (def item (map first smooth-bin))
  item
  ;; => (633 245 245 245 245 245 245 245 245 247)
  ...
  (smooth-line line)
  ;; => {:tool :pen, :points ([245 410] [245 428])}
